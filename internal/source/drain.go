...
// Drain triggers a one-shot evacuation: hands off ALL synced torrents to destination,
...
// MaybeMoveToDest is the exported version of maybeMoveToDest for testing.
func (t *QBTask) MaybeMoveToDest(ctx context.Context) error {
	return t.maybeMoveToDest(ctx)
}
