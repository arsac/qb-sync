...
func NewQBTask(
	...
	defaults := streaming.DefaultBidiQueueConfig()
	defaults.MaxBytesPerSec = cfg.MaxBytesPerSec
	defaults.RetryDelay = defaultRetryDelay
	defaults.AdaptiveWindow = windowConfig
	if cfg.ReconnectMaxDelay > 0 {
		defaults.ReconnectMaxDelay = cfg.ReconnectMaxDelay
	}
