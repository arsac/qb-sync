...
type FinalizeTorrentRequest struct {
	...
	SaveSubPathExplicit bool                   `protobuf:"varint,6,opt,name=save_sub_path_explicit,json=saveSubPathExplicit,proto3" json:"save_sub_path_explicit,omitempty"` // True when save_sub_path is explicitly set (distinguishes "" from unset for backwards compat)
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *FinalizeTorrentRequest) GetSaveSubPathExplicit() bool {
	if x != nil {
		return x.SaveSubPathExplicit
	}
	return false
}
...
const file_qbsync_proto_rawDesc = "" +
	...
	"\rsave_sub_path\x18\x05 \x01(\tR\vsaveSubPath\x123\n" +
	"\x16save_sub_path_explicit\x18\x06 \x01(\bR\x13saveSubPathExplicit\"\x99\x01\n" +
