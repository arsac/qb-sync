...
const (
	...
	FinalizeErrorCode_FINALIZE_ERROR_BUSY       FinalizeErrorCode = 3 // Destination congested (finalize queue timeout, or qB still checking at budget expiry); retry without penalty
)
...
const file_qbsync_proto_rawDesc = "" +
	...
	"\fpre_existing\x18\x06 \x01(\bR\vpreExisting\"\xe1\x01\n" +
	...
	"\x16PIECE_ERROR_FINALIZING\x10\x04*\x82\x01\n" +
	"\x11FinalizeErrorCode\x12\x17\n" +
	"\x13FINALIZE_ERROR_NONE\x10\x00\x12\x1d\n" +
	"\x19FINALIZE_ERROR_INCOMPLETE\x10\x01\x12\x1c\n" +
	"\x18FINALIZE_ERROR_NOT_FOUND\x10\x02\x12\x17\n" +
	"\x13FINALIZE_ERROR_BUSY\x10\x03*_\n" +
