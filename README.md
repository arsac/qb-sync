...
| `QBSYNC_DESTINATION_VERIFY_CONCURRENCY` | `--verify-concurrency` | Concurrent piece-read goroutines per read-back verification pass - at init, early finalization, and full finalization (0 = default 4). Raise on healthy storage; lower if your NFS server can't handle the burst | `0` |
